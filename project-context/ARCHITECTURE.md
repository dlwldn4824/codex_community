...
- `SecurityRetriever`: retrieves top-k evidence independently from global security documents and project-specific intent using capped term-frequency lexical scoring.
...
The current offline demo exposes structured analysis as `DETERMINISTIC_FALLBACK`; it does not claim that this mapping was generated by a live neural model. Retrieval supplies supporting criteria and provenance but cannot set or override the symbolic verdict.
